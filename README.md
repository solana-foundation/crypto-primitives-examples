...
| SHA-512                  | [0512](https://github.com/solana-foundation/solana-improvement-documents/blob/main/proposals/0512-sha512-syscall.md)        | proposed syscall (`sol_sha512`)       | hash-specific  | SHA-512 hash, 64-byte digest | pending; no cluster activation |
